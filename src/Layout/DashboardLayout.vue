  ...
  <div class="flex min-h-screen bg-gray-50">
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-center items-center">
          <button class="bg-red-500 text-white px-4 py-2 rounded-lg" @click="logout">Log Out</button>
          <button class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg ml-2" @click="isLogout = false">Cancel</button>
        </div>
      </div>
    </div>
