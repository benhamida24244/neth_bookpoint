  ...
  >
    <div class="flex flex-wrap items-center justify-between gap-5 w-full">
      ...
      >
        ...
        <ul
          class="font-BonaRegular lg:flex gap-x-4 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50"
        >
          ...
          <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
            <a
              ...
              class="hover:text-yellow-700 text-yellow-700 block font-medium text-[15px]"
              >Home</a
            >
          </li>
          <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
            <a
              href="javascript:void(0)"
              class="hover:text-yellow-700 text-white block font-medium text-[15px]"
              >Team</a
            >
          </li>
          <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
      ...
      <div class="flex max-lg:ml-auto space-x-4">
        ...
        <button id="toggleOpen" class="lg:hidden cursor-pointer text-yellow-600">
