  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 font-BonaRegular">
    <div class="container mx-auto p-6 max-w-7xl">
      ...
      <div v-else-if="authStore.error" class="text-center py-20 text-red-500">
        <p>{{ t('profile.failedToLoadProfile') }}{{ authStore.error }}</p>
      </div>
      ...
      <div v-else-if="currentUser" class="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div class="xl:col-span-1">
          <div
            class="relative bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-white/50 hover:shadow-2xl transition-all duration-300"
          >
            <div class="flex items-center gap-6 mb-6">
              <div class="relative">
                ...
                <div
                  v-else
                  class="w-20 h-20 rounded-full shadow-lg border-4 border-white bg-gray-300 flex items-center justify-center"
                >
            ...
            <div class="space-y-4">
              <div
                class="flex items-center gap-3 p-3 rounded-lg bg-gray-50/80 hover:bg-blue-50/80 transition-colors"
              >
              ...
              >
                ...
                <div>
                  ...
                  <p class="font-semibold text-gray-800">
                    {{ currentUser.phone_number || t('profile.notSet') }}
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <p class="font-semibold text-gray-800">
                    {{ currentUser.country || t('profile.notSet') }}
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <p class="font-semibold text-gray-800">
                    {{ currentUser.address || t('profile.notSet') }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <button
              @click="handleLogout"
              class="w-full mt-6 bg-red-500 text-white py-2.5 rounded-lg font-semibold hover:bg-red-600 transition-all duration-300 shadow-md hover:shadow-lg"
            >
              {{ t('profile.logout') }}
            </button>
          </div>
        ...
        <div class="xl:col-span-2 space-y-8">
          <!-- Shopping Cart -->
          <div
            class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl border border-white/50 overflow-hidden"
          >
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-blue-100">
                      {{ t('profile.itemsInCart', { count: cartItems.length }) }}
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                <div class="flex justify-end mt-6 col-span-full">
                  <button
                    ...
                    class="bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-hover)] text-white py-3 px-8 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-2"
                  >
          ...
          >
              ...
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-emerald-100">
                    {{ t('profile.totalOrders', { count: userOrders.length }) }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-6">
              ...
              <div v-else-if="userOrders.length > 0" class="space-y-6">
                ...
                >
                  <div
                    class="bg-gradient-to-r from-gray-50 to-blue-50 px-6 py-4 border-b border-gray-100"
                  >
