  ...
  routes: [
    ...
    },
    {
      ...
      children:[
        ...
        {path:'orders', name:'Orders page' , component:() => import('@/views/Dashboard/OrdersView.vue')},
        ...
        {path:'books', name:'Books page' , component:() => import('@/views/Dashboard/BooksView.vue')},
        {path:'books/:id', name:'Books info' , component:() => import('@/views/Dashboard/BookDetails.vue')},
        {path:'categories', name:'Categories page' , component:() => import('@/views/Dashboard/CategoriesView.vue')},
