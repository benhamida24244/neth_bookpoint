  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'category/:id', name: 'public Category info', component: () => import('@/views/Category/SingleCategoryPage.vue') },
        { path: '/publishing-house/:id', name: 'public Publishing House info', component: () => import('@/views/Publishing/SinglePublishingHousePage.vue') },
